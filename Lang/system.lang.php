...
//Date: 2014-7-8
//系统的语言信息
return array ('ZH_CN' => array ('DEFAULT_INDEX_NOT_FOUND' => '默认主页不存在！~', 
                                'FIELD_REQUIRED' => '字段"{FIELD_NAME}"必须填写~',
								'NUMERAL_REQUIRED'=>'字段"{FIELD_NAME}"只能是数字',
								'UNIQUED_REQUIRED'=>'字段"{FIELD_NAME}"需要唯一',
              ...
              'EN_US' => array ('DEFAULT_INDEX_NOT_FOUND' =>'The default home page does not exist',
                                ...
                                'NUMERAL_REQUIRED'=>'Field "{FIELD_NAME}" is the only digital',
                                'UNIQUED_REQUIRED'=>'Field "{FIELD_NAME}" requires unique',
